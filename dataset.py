...
class SoundDataset(Dataset):
    def __init__(self, annotation, data_type, length, augment, prop_tp=None):
        ...
        self.unlabel = glob('/home/cybercore/oldhome/datasets/rain_forest/data_waveform/test_pseudo/*.npy') 
        self.length = length
...
if __name__ == '__main__':
    ...
    loader = get_loader(annotation='fold/3/train_list.txt', data_type='train', batch_size=2, num_workers=0,
